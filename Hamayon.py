...
\033[1;91m☞ Auther     : HamayonOO
\033[1;92m☞ WhatsApp   : +93706497074
\033[1;95m☞ YouTube    : https://youtube.com/channel/UCAsbQ86LwMr8dEbBTbJNObQ
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' New Hamayonoo Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' working in All countries ')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('WhatsApp Num +93706497074✓')
	    psb('WellCome To HamayonOOTool')
	    psb('Congratulations HamayonOOTool Has Been Updated Successfully')
	    psb('🔓User Name☆ Hamayon ✓')
	    psb('🔓Password ☆ OO✓')
	    psb('Subscrib My Youtube Channel KAR Technical ✓')
